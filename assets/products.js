...
window.KH_PRODUCTS = {
  frozen: {
    label: "냉동·수산",
    delivery: "8월 23일경 배송 예정 (변경 시 사전 안내)",
    sections: [
      {
        id: "mandu",
        tab: "냉동·간편식",
        ...
        items: [
          {
            ...
            detailImages: [
              "assets/images/products/detail-seoul/01.jpg",
              "assets/images/products/detail-seoul/02.jpg",
              "assets/images/products/detail-seoul/03.jpg",
              "assets/images/products/detail-seoul/04.jpg",
            ],
          },
          {
            id: "b2",
            ...
            detailImages: [
              ...
              "assets/images/products/detail-pogi/04.jpg",
        ...
        items: [
          {
            ...
            detailImages: [
              "assets/images/products/detail-chonggak/01.jpg",
              "assets/images/products/detail-chonggak/02.jpg",
              "assets/images/products/detail-chonggak/03.jpg",
              "assets/images/products/detail-chonggak/04.jpg",
              "assets/images/products/detail-chonggak/05.jpg",
              "assets/images/products/detail-chonggak/06.jpg",
            ],
          },
          {
            id: "b5",
            ...
            detailImages: [
              "assets/images/products/detail-yeolmu/01.jpg",
              "assets/images/products/detail-yeolmu/02.jpg",
              "assets/images/products/detail-yeolmu/03.jpg",
              "assets/images/products/detail-yeolmu/04.jpg",
              "assets/images/products/detail-yeolmu/05.jpg",
              "assets/images/products/detail-yeolmu/06.jpg",
            ],
          },
          {
            id: "b6",
            ...
            detailImages: [
              "assets/images/products/detail-jjokpa/01.jpg",
              "assets/images/products/detail-jjokpa/03.jpg",
              "assets/images/products/detail-jjokpa/04.jpg",
              "assets/images/products/detail-jjokpa/05.jpg",
              "assets/images/products/detail-jjokpa/06.jpg",
            ],
          },
          {
            id: "b7",
            ...
            detailImages: [
              "assets/images/products/detail-gat/01.jpg",
              "assets/images/products/detail-gat/03.jpg",
              "assets/images/products/detail-gat/04.jpg",
              "assets/images/products/detail-gat/05.jpg",
              "assets/images/products/detail-gat/06.jpg",
            ],
          },
        ],
      },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "w_set3a", tier: "set3", name: "3 SET ①", desc: "배추김치 3개", price: 195, premium: true, image: "assets/images/walkerhill/pogi.jpg" },
          { id: "w_set3b", tier: "set3", name: "3 SET ②", desc: "배추김치 2개 + 총각김치 1개", price: 180, premium: true, image: "assets/images/walkerhill/set.jpg" },
          { id: "w_set3c", tier: "set3", name: "3 SET ③", desc: "배추김치 1개 + 총각김치 2개", price: 165, premium: true, image: "assets/images/walkerhill/set.jpg" },
          { id: "w_set3d", tier: "set3", name: "3 SET ④", desc: "총각김치 3개", price: 150, premium: true, image: "assets/images/walkerhill/chonggak.png" },
          { id: "w_set5a", tier: "set5", name: "5 SET ①", desc: "배추김치 5개", price: 320, premium: true, image: "assets/images/walkerhill/pogi.jpg" },
          { id: "w_set5b", tier: "set5", name: "5 SET ②", desc: "배추김치 3개 + 총각김치 2개", price: 295, premium: true, image: "assets/images/walkerhill/set.jpg" },
          { id: "w_set5c", tier: "set5", name: "5 SET ③", desc: "배추김치 2개 + 총각김치 3개", price: 280, premium: true, image: "assets/images/walkerhill/set.jpg" },
          { id: "w_set5d", tier: "set5", name: "5 SET ④", desc: "총각김치 5개", price: 250, premium: true, image: "assets/images/walkerhill/chonggak.png" },
        ],
      },
    ],
  },
